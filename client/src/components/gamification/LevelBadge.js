...
export function LevelBadge({ level, currentXp, progress: _progress, size = 'md' }) {
    ...
    return (_jsxs("div", { className: "flex items-center gap-4", children: [_jsx("div", { className: clsx('rounded-xl border-2 flex items-center justify-center shrink-0', levelColors[level.levelNumber] || 'text-gray-400 border-gray-500/30', sizeClasses[size]), children: _jsx(Icon, { className: "w-1/2 h-1/2" }) }), _jsxs("div", { className: "min-w-0", children: [_jsx("div", { className: clsx('font-bold text-white truncate', labelSize[size]), children: level.name }), _jsxs("div", { className: clsx('text-gray-400', size === 'sm' ? 'text-xs' : 'text-sm'), children: ["Nivel ", level.levelNumber] }), _jsxs("div", { className: clsx('text-gray-500', size === 'sm' ? 'text-xs' : 'text-sm'), children: [currentXp.toLocaleString(), " XP"] })] })] }));
}
//# sourceMappingURL=LevelBadge.js.map